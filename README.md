...
This README describes the current implementation. The extension manifest reports **0.6.10**; `package.json` still reports `0.1.0`. No minimum compatible SillyTavern version is declared or verified.
